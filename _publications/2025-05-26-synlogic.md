...
excerpt: 'A framework for synthesizing verifiable reasoning data at scale to improve logical reasoning in large language models and beyond.'
date: 2025-05-26
venue: 'Arxiv'
...
This work (first-authored by Junteng Liu) introduces SynLogic, a framework for synthesizing verifiable reasoning data at scale, enabling models to learn logical reasoning and generalize beyond. Code is available on GitHub.
